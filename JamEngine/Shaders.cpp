...
Shader Shader::Create(ID3DBlob* _pVScode_orNull, ID3DBlob* _pPScode_orNull, ID3DBlob* _pGScode_orNull, ID3DBlob* _pHScode_orNull, ID3DBlob* _pDScode_orNull)
{
    Shader shader;
...
void Shader::CreateInputLayout_(ID3DBlob* _pVSCode)
{
